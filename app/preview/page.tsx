...
const FIXTURE: PlannerSnapshot = {
  ...
  deadlines: [
    { id: "d1", course_id: "c3", canvas_assignment_id: "1", title: "Plate 4 — isometric assembly drawing", due_at: at(0, 11, 0), type: "assignment", points_possible: 100, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d2", course_id: "c1", canvas_assignment_id: "2", title: "Quiz 2 — addressing modes", due_at: at(1, 9, 15), type: "quiz", points_possible: 40, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d3", course_id: "c2", canvas_assignment_id: "3", title: "Problem set 3 — line coding", due_at: at(2, 23, 59), type: "assignment", points_possible: 50, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d4", course_id: "c4", canvas_assignment_id: "4", title: "Machine problem 1 — Newton-Raphson", due_at: at(3, 23, 59), type: "assignment", points_possible: 100, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d5", course_id: "c5", canvas_assignment_id: "5", title: "Case study writeup", due_at: at(4, 16, 15), type: "assignment", points_possible: 60, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d6", course_id: "c1", canvas_assignment_id: "6", title: "Laboratory report 3", due_at: at(4, 23, 30), type: "assignment", points_possible: 30, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d7", course_id: "c2", canvas_assignment_id: "7", title: "Long exam 1", due_at: at(6, 11, 0), type: "exam", points_possible: 100, canvas_url: null, status: "open" , source: "canvas", notes: null },
    { id: "d8", course_id: "c4", canvas_assignment_id: "8", title: "Seatwork 5", due_at: at(1, 16, 15), type: "assignment", points_possible: 20, canvas_url: null, status: "graded" , source: "canvas", notes: null },
    { id: "d9", course_id: "c5", canvas_assignment_id: "9", title: "Group project proposal", due_at: null, type: "assignment", points_possible: 80, canvas_url: null, status: "open" , source: "canvas", notes: null },
  ],
  files: [
